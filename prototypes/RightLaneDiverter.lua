	...
	{
		{
			...
			icon = "__Belt-Utils__/graphics/rightlanediverter.png",
			flags = { "goes-to-quickbar" },
			subgroup = "belt",
			place_result="Right Lane Diverter",
			stack_size= 50,
		},
	}
)
	...
	{
		{
			...
			minable = {hardness = 0.2, mining_time = 0.5, result = "Right Lane Diverter"},
			max_health = 40,
			...
			platform_picture =
			{
				sheet = 
				{
					filename = "__Belt-Utils__/graphics/rightlanediverter-large.png",
					priority = "extra-high",
					width = 64,
					height = 44,
				}
